...
execute @p[tag=!q3_3] ~~~ detect 1197 100 647 barrel 12 tag @a add q3_3
execute @p[x=1193,y=100,z=643,r=20,tag=!q3_3] ~~~ title @a actionbar §g Inside Search Zone
...
execute @p[tag=q3_3,tag=!c3_3,tag=!gotten_all] ~~~ title @a subtitle §6Key Found
execute @p[tag=q3_3,tag=!c3_3,tag=!gotten_all] ~~~ function quests/on/update

execute @p[tag=q3_1,tag=q3_2,tag=q3_3,tag=!c3_3] ~~~ title @a subtitle §6Return to the Commander at the MNLI Headquarters
...
execute @p[tag=q3_1,tag=q3_2,tag=q3_3] ~~~ tag @a add gotten_all
execute @p[tag=gotten_all] ~~~ execute @p[x=890,y=68,z=606,r=12] ~~~ scoreboard players set @a seq 2
execute @p[tag=q3_3,tag=q3_2,tag=q3_1] ~~~ setworldspawn 890 255 606
execute @p[tag=!q3_3,tag=q3_2,tag=q3_1] ~~~ setworldspawn 1197 100 647
