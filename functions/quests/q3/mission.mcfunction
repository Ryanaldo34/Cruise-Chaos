...
execute @p[tag=q3_3] ~~~ title @a subtitle §6Return to the Commander at the MNLI Headquarters
execute @p[tag=q3_3] ~~~ function quests/on/update
execute @p[tag=q3_1,tag=!c3_1,tag=!gotten_all] ~~~ title @a subtitle §6Drift Anchor Found
...
execute @p[tag=q3_3,tag=!c3_3,tag=!gotten_all] ~~~ title @a subtitle §6Fuel Tank Found
