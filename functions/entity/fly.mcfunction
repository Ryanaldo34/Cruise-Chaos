...
execute @a[rxm=-5,rx=20] ~~~ effect @e[type=cc:helicopter] levitation 1 1 true
execute @a[rxm=20,rx=35] ~~~ effect @e[type=cc:helicopter] slow_falling 1 1 true
execute @a[rxm=35,rx=90] ~~~ effect @e[type=cc:helicopter] clear